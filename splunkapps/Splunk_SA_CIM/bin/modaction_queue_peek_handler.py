...
from splunk_sa_cim.modaction_queue import ModularActionQueueBR, ModularActionQueueISE, ModularActionQueueUnauth, ModularActionQutils, ModularActionQueueMissingFP
...
class ModularActionQueuePeekHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, args):
        ...
        except ModularActionQueueMissingFP as e:
            msg = 'ModularActionException: {0}'.format(e)
            return self.modaction_qutils.error(
                msg, http_client.NOT_FOUND)
