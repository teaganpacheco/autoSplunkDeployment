    ...
    def run(self, params):
        ...
        for action in actions:
            ...
            with self.ensure_local_dispatch_dir(stanza_name, sid) as dispatch_dir:
                try:
                    # modify target URL to locate the SH that created the AR action
                    # example: https://<sh-id>.<stack-id>.splunkcloud.com:443
                    # server_host - search head ID
                    # target - generic stack ID URL
